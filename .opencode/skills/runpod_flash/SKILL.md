...
### CLI Gotchas
- If the project has flash installed locally (pyproject.toml, etc.), then all flash invocations on the cli just need to be `uv run flash` followed by the commands mentioned above.
